...
/* reset password */
Route::get('/reset-password/{token}', \App\Http\Livewire\ForgetPassword::class, '__invoke')->middleware(['installed'])->name('reset_password');
/* admin section */
Route::group(['prefix' => 'admin', 'middleware' => ['admin', 'installed']], function () {
